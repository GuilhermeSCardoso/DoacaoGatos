...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private static final int REQUISICAO_GPS = 1;
    private GoogleMap mMap;
    private Location locAtual = null;
    ...
    protected void onStart() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                Toast.makeText(MapsActivity.this, getString(R.string.alerta_gps), Toast.LENGTH_SHORT).show();
            }
    ...
    private void colocarGatoNoMapa() {
        ...
        database.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                //double latitude = gato.localizacao.latitude;
                //double longitude = gato.localizacao.longitude;
